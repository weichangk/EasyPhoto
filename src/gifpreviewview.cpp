...
void GifPreviewView::createUi() {
    ...
    m_pExitBtn->setFourPixmapPath(":/qtmaterial/img/vcu/dark/old/icon/icon_state/icon24/icon24_delete.png");

    m_pPlayBtn = new IconButton(this);
    m_pPlayBtn->setFixedSize(24, 24);
    m_pPlayBtn->setIconSize(24, 24);
    m_pPlayBtn->setFourPixmapPath(":/qtmaterial/img/vcu/dark/old/icon/icon_state/icon24/icon24_delete.png");
    m_pPlayBtn->setVisible(false);
