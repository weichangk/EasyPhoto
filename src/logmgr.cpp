...
void LogMgr::outputMessage(QtMsgType type, const QMessageLogContext &context, const QString &msg)
{
...
void LogMgr::writeLine(QString logFileName, QString logMessage)
{
...
void LogMgr::log(QString logFileName, QString logMessage)
{
    static QMutex mutex;
    mutex.lock();
