...
ScalelListDelegate::ScalelListDelegate(QObject *parent) :
    QStyledItemDelegate(parent) {
}

void ScalelListDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const {
...
bool ScalelListDelegate::eventFilter(QObject *object, QEvent *event) {
    int type = event->type();
...
QSize ScalelListDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const {
    return m_Size;
}