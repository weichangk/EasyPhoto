...
QVBoxLayout *NavbarView::createNavBtns() {
    ...
    navMap[EFunc::FuncHome] = {QString(":/qtmaterial/img/vcu/%1/v16/icon24/icon24_home.svg").arg(qtmaterialcore::Theme::currentTheme()), tr("Home")}; 
    navMap[EFunc::FuncMyFile] = {QString(":/qtmaterial/img/vcu/%1/v16/icon24/icon24_file.svg").arg(qtmaterialcore::Theme::currentTheme()), tr("My Files")}; 
    navMap[EFunc::FuncConversion] = {QString(":/qtmaterial/img/vcu/%1/v16/icon24/icon24_converter.svg").arg(qtmaterialcore::Theme::currentTheme()), tr("Converter")}; 
    navMap[EFunc::FuncCompression] = {QString(":/qtmaterial/img/vcu/%1/v16/icon24/icon24_compress.svg").arg(qtmaterialcore::Theme::currentTheme()), tr("Compressor")}; 
    ...
    navMap[EFunc::FuncGifMaker] = {QString(":/qtmaterial/img/vcu/%1/v16/icon24/icon24_gif maker.svg").arg(qtmaterialcore::Theme::currentTheme()), tr("GIF Maker")}; 
    ...
    for (iter = navMap.begin(); iter != navMap.end(); ++iter) {
        ...
        if(iter.key() == EFunc::FuncMyFile) {
            ...
            hot->setNormalPixmapPath(QString(":/qtmaterial/img/vcu/%1/v16/icon20/icon20_hot.png").arg(qtmaterialcore::Theme::currentTheme()));
            hot->setText(tr("Hot"));
