...
// HomeFuncItemDelegate::HomeFuncItemDelegate(QObject *parent) :
//     QStyledItemDelegate(parent) {
// }

// void HomeFuncItemDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const {
...
// bool HomeFuncItemDelegate::eventFilter(QObject *object, QEvent *event) {
//     int type = event->type();
...
// QSize HomeFuncItemDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const {
//     return m_Size;
// }
