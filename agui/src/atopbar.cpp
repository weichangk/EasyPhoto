...
void ATopbar::mousePressEvent(QMouseEvent *event)
{
...
void ATopbar::mouseMoveEvent(QMouseEvent *event)
{
...
void ATopbar::mouseReleaseEvent(QMouseEvent *event)
{
    m_isMousePressed = false;
    ABaseWidget::mouseReleaseEvent(event);
}

void ATopbar::showEvent(QShowEvent *event)
{
    ABaseWidget::showEvent(event);
}

void ATopbar::resizeEvent(QResizeEvent *event)
{
